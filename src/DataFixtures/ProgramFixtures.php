...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $program->addActor($this->getReference(ActorFixtures::ACTOR_CLINT_EASTWOOD));
        ...
        $program->setCategory($this->getReference(CategoryFixtures::CATEGORY_HORREUR));
        $program->addActor($this->getReference(ActorFixtures::ACTOR_JASON_STATHAM));
        ...
        $program->setCategory($this->getReference(CategoryFixtures::CATEGORY_HORREUR));
        $program->addActor($this->getReference(ActorFixtures::ACTOR_LEONARDO_DICAPRIO));
        ...
        $program->setCategory($this->getReference(CategoryFixtures::CATEGORY_HORREUR));
        $program->addActor($this->getReference(ActorFixtures::ACTOR_QUENTIN_TARANTINO));
        ...
        $program->setCategory($this->getReference(CategoryFixtures::CATEGORY_HORREUR));
        $program->addActor($this->getReference(ActorFixtures::ACTOR_TOM_CRUISE));
